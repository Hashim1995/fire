const DocumentTypes = [
  {
    value: 1,
    label: "Əvvəlki Şengen vizalarının və ölkəyə giriş/çıxış möhürləri",
  },
  ...
  { value: 4, label: "E-govdan arayış (ingiliscə və notarial təsdiqli)" },
  {
    value: 5,
    label:
      "Adınız mülk varsa onun təsdiqi (notarial təsdiqli və ingilis dilində",
  },
  { value: 6, label: "Maaş kart hesabında çıxarış" },
  {
    value: 7,
    label: "Bank hesabından arayış və çıxarış (1 gün x150 evro olmaqla",
  },
  ...
  { value: 11, label: "Aviabilet bronu" },
  {
    value: 12,
    label:
      "Evlisinizsə Nigah haqqında şəhadətnamə, ayrılmısınızsa nigahın pozulması haqqında şəhadətnamə",
  },
  {
    value: 13,
    label: "Sponsorluq ərizəsi (ingilis dilində və notarial təsdiqli)",
  },
];
...
function validateDates(firstDate, secondDate) {
  ...
  if (departureDate < today) {
    return {
      message: " Gediş tarixi bugündən əvvəl ola bilməz",
      status: false,
    };
  }
  ...
  if (returnDate < departureDate) {
    return {
      message: "Gəliş tarixi Gediş tarixindən əvvəl ola bilməz",
      status: false,
    };
  } else {
