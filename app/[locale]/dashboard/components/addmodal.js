            ...
            <ModalBody>
                <div className="col-lg-12 gap-3 login-form">
                    <Nav className="justify-content-center" tabs>
                        <NavItem>
                            <NavLink disabled={activeTab !== '1'} className={activeTab == '1' ? 'active' : ''} onClick={() => setActiveTab('1')}>
                                {t('generalInfo')}
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink disabled={activeTab !== '2'} className={activeTab == '2' ? 'active' : ''} onClick={() => setActiveTab('2')}>
                                {t("passportInfo")}
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink disabled={activeTab !== '3'} className={activeTab == '3' ? 'active' : ''} onClick={() => setActiveTab('3')}>
                                {t("deailedInfo")}
                            </NavLink>
                        </NavItem>
                    </Nav>
                    <TabContent activeTab={activeTab}>
                        <TabPane className="mt-2" tabId="1"><AddModalFirst globalSetter={setValue} globalWatch={watch} setActiveTab={setActiveTab} setShouldOpenTab={setShouldOpenTab} /></TabPane>
                        <TabPane className="mt-2" tabId="2"><AddModalSecond setExtractData={setExtractData} globalSetter={setValue} globalWatch={watch} setActiveTab={setActiveTab} setShouldOpenTab={setShouldOpenTab} /></TabPane>
                        <TabPane className="mt-2" tabId="3"><AddModalThird setModal={setModal} extractData={extractData} globalSetter={setValue} globalWatch={watch} setActiveTab={setActiveTab} setShouldOpenTab={setShouldOpenTab} /></TabPane>
