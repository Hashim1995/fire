...
const AddModalSecond = ({
    ...
    const onSubmit = async (event) => {
        ...
        formData.append('DestinationCountryId', globalWatch('DestinationCountryId')?.value);
        ...
        try {
            ...
            const response = await axios.post('https://ivisaapp.azurewebsites.net/api/v1/visa/document/extract', formData, {
                headers: {
            ...
            console.log(response.data, 'subhan');
