                    ...
                    <div className="mb-3">
                                ...
                                <Select
                                    ...
                                    styles={{
                                        menuPortal: (base, state) => ({
                                            ...base, zIndex: 9999, borderColor: state.isFocused ?
                                                '#ddd' : errors.DestinationCountryId ?
                                                    '#ddd' : 'red',
                        ...
                        {errors.DestinationCountryId && (
                            <div style={{
                                ...
                                fontSize: ' .875em',
                                color: '#dc3545',
                            }}>{errors.DestinationCountryId.message}</div >
                        )}
                    </div>
                </div>
                <div className="col-sm-6">
                    <div className="mb-3">
                        ...
                        {errors.EntryCountry && (
                            <div style={{
                                ...
                                fontSize: ' .875em',
                                color: '#dc3545',
                            }}>{errors.EntryCountry.message}</div >
                        )}
                    </div>
                </div>
                <div className="col-sm-6">
