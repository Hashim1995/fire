...
const RegisterFirst = ({ setShouldOpenTab, setActiveTab, globalSetter, globalWatch }) => {
    ...
    return <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="col-sm-6">
                <div className="mb-3">
                    <Controller
                        control={control}
                        rules={
                            { required: { value: true, message: `${t("Firstname")} ${t("IsRequired")}` } }
                        }
                        name="firstname"
            ...
            <div className="col-sm-6">
                <div className="mb-3">
                    <Controller
                        control={control}
                        rules={
                            { required: { value: true, message: `${t("Lastname")} ${t("IsRequired")}` } }
                        }
                        name="lastname"
                        render={({ field: { onChange, value } }) => (
                            <Input
            ...
            <div className="col-sm-6">
                <div className="mb-3">
                    <Controller
                        control={control}
                        rules={
                            { required: { value: true, message: `${t("Birthday")} ${t("IsRequired")}` } }
                        }
                        name="birthday"
                        render={({ field: { onChange, value } }) => (
                            <Input
        ...
        <div className="mb-3">
            ...
            <Button disabled={loading} type="submit" className="theme-btn me-1 border-0 rounded-0 btn-style-one"><span className="btn-title text-white">{
                loading ?
                    <Spinner
