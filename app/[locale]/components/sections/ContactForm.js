            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="col-sm-6">
                        <div className="mb-3">
                            <Controller
                                control={control}
                                rules={
                                    { required: { value: true, message: `${t("Title")} ${t("IsRequired")}` } }
                                }
                                name="title"
                                render={({ field: { onChange, value } }) => (
                                    <Input
                ...
                <div className="mb-3">
                    <Controller
                        control={control}
                        rules={
                            { required: { value: true, message: `${t("Description")} ${t("IsRequired")}` } }
                        }
                        name="description"
                        render={({ field: { onChange, value } }) => (
                            <Input
                ...
                <div className="mb-3">
                    ...
                    <button onClick={() => reset()} type="button" className="theme-btn btn-style-one bg-theme-color5">
