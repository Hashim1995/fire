              ...
              <div className="blog-details__left">
                ...
                <div className="blog-details__content">
                  ...
                  <p className="blog-details__text-2">
                    Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod nec, feugiat at nisi. Quisque vitae odio nec lacus interdum
                    tempus. Phasellus a rhoncus erat. Vivamus vel eros vitae est aliquet pellentesque vitae et nunc. Sed vitae leo vitae nisl pellentesque semper.
                  </p>
                  <p className="blog-details__text-2">
                    Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod nec, feugiat at nisi. Quisque vitae odio nec lacus interdum
                    tempus. Phasellus a rhoncus erat. Vivamus vel eros vitae est aliquet pellentesque vitae et nunc. Sed vitae leo vitae nisl pellentesque semper.
                ...
                <div className="blog-details__bottom">
                  <p className="blog-details__tags">
                    {" "}
                    <span>Tags</span> <Link href="/news-details">Technology</Link> <Link href="/news-details">Software</Link>{" "}
                  </p>
                ...
                <div className="comment-one">
                  ...
                  <div className="comment-one__single">
                    ...
                    <div className="comment-one__content">
                      <h3>Kevin Martin</h3>
                      <p className="blog-details__text-2">Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod.</p>
              ...
              <div className="sidebar">
                ...
                <div className="sidebar__single sidebar__category">
                  ...
                  <ul className="sidebar__category-list list-unstyled">
                    <li>
                      <Link href="/news-details">
                        Artifical Intelligence<span className="icon-right-arrow"></span>
                      </Link>{" "}
                    </li>
                    <li className="active">
                      <Link href="/news-details">
                        Cloud Solution<span className="icon-right-arrow"></span>
                      </Link>
                    </li>
                    <li>
                      <Link href="/news-details">
                        Cyber Data<span className="icon-right-arrow"></span>
                      </Link>{" "}
                    </li>
                    <li>
                      <Link href="/news-details">
                        SEO Marketing<span className="icon-right-arrow"></span>
                      </Link>{" "}
                    </li>
                    <li>
                      <Link href="/news-details">
                        UI/UX Design<span className="icon-right-arrow"></span>
                      </Link>{" "}
                    </li>
                    <li>
                      <Link href="/news-details">
                ...
                <div className="sidebar__single sidebar__tags">
                  ...
                  <div className="sidebar__tags-list">
                    {" "}
                    <Link href="#">Consulting</Link> <Link href="#">Cyber</Link> <Link href="#">Development</Link> <Link href="#">Digital</Link> <Link href="#">Software</Link> <Link href="#">Technology</Link>{" "}
                  </div>
                </div>
