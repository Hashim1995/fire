...
async function getData() {
    ...
    const res = await fetch(
        `https://ivisaapp.azurewebsites.net/api/v1/blog/latest?Language=${returnCurrentLangId(
            t
        )}`,
        {
            method: "GET",
                                ...
                                <div className="footer-widget about-widget">
                                    ...
                                    <ul className="contact-info">
                                        <li>
                                            ...
                                            <Link href={`mailto:${dataContacts?.email}`}>{dataContacts?.email}</Link>
                                            <br />
                                        </li>
                                        <li>
                                                    ...
                                                    <figure className="image">
                                                        <Link href={`/news-grid/${z.slug}/${z?.id}`}>
                                                            <img
                                                                ...
                                                                src={`https://ivisaapp.azurewebsites.net/${z?.imageUrl}`}
                                                                title="Vixoz"
                                                            />
                                                        </Link>
                                                    </figure>
